...
In this lab, you will learn how to persist data generated by your docker container.

Navigate to the folder `20_volumes` from the CLI before you get started.

```bash
cd /training/20_volumes
```
